...
#ifndef NAV2_STATIC_PLANNER__PLANNER_SERVER_HPP_
#define NAV2_STATIC_PLANNER__PLANNER_SERVER_HPP_
...
protected:
  ...
  rclcpp::Subscription<PolygonStamped>::SharedPtr footprint_sub_;
  geometry_msgs::msg::Point32::SharedPtr current_pose_;

  void footprint_to_pose(
...
#endif  // NAV2_STATIC_PLANNER__PLANNER_SERVER_HPP_
