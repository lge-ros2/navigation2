...
#ifndef NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__CHECK_ROBOT_ORIENTATION_HPP_
#define NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__CHECK_ROBOT_ORIENTATION_HPP_
 ...
 */
class CheckRobotOrientation : public BT::ActionNodeBase
{
public:
  /**
   * @brief A nav2_behavior_tree::CheckRobotOrientation constructor
  ...
  static BT::PortsList providedPorts()
  {
    return {
      ...
      BT::InputPort<float>(
        "threshold", 1.0,
        "difference of angle radian value between path and robot")
    };
  }
...
#endif  // NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__CHECK_ROBOT_ORIENTATION_HPP_
