...
#ifndef NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__SET_LPP_GOAL_HPP_
#define NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__SET_LPP_GOAL_HPP_
 ...
 */
class SetLppGoal : public BT::ActionNodeBase
{
public:
  /**
   * @brief A nav2_behavior_tree::SetLppGoal constructor
  ...
  static BT::PortsList providedPorts()
  {
    return {
      ...
      BT::OutputPort<geometry_msgs::msg::PoseStamped>(
        "lpp_goal", "Lpp goal by path truncated to a certain distance around robot"),
...
#endif  // NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__SET_LPP_GOAL_HPP_
