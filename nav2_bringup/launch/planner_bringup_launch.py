...
def generate_launch_description():
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        'rviz_config',
        default_value=os.path.join(bringup_dir, 'rviz', 'nav2_cloi_planner.rviz'),
    ...
    start_namespaced_rviz_cmd = Node(
        ...
        remappings=[('/tf', 'tf'),
                    ...
                    ('/static_global_costmap/costmap', 'static_global_costmap/costmap'),
                    ('/static_global_costmap/costmap_updates', 'static_global_costmap/costmap_updates'),
                    ('/plan', 'plan'),
